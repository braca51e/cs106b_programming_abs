#ifndef MultiwayMerge_Included
#define MultiwayMerge_Included

#include "DataPoint.h"
#include "vector.h"

/**
 * Given a list of several different sorted sequences, merges all those sorted sequences
 ...
 *
 * @param toMerge The list of sorted sequences to merge. Each sequence is sorted, by weight,
 *                in ascending order.
 * @return A list of all of the elements of those sequences in sorted order.
 */
Vector<DataPoint> mergeSequences(const Vector<Vector<DataPoint>>& toMerge);

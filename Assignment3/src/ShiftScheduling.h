 ...
 * shift.
 *
 * You can assume that each potential shift will also be a key in the map associating
 * shifts with their value, though there could conceivably be some other keys in the map
 * that correspond with shifts that aren't available for the employee.
 *
 ...
 *
 * @param shifts A Set containing all the potential shifts that could be assigned.

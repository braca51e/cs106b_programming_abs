...
SOURCES *= $$files($$PWD/src/Demos/*.cpp)
SOURCES *= $$files($$PWD/src/Testing/*.cpp)
SOURCES *= $$files($$PWD/src/Utilities/*.cpp)
...
HEADERS *= $$files($$PWD/src/Demos/*.h)
HEADERS *= $$files($$PWD/src/Testing/*.h)
HEADERS *= $$files($$PWD/src/Utilities/*.h)
